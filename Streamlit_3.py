# Note: Run this app using `streamlit run Streamlit.py`, not `python Streamlit.py`
...
# Function to fetch and optionally stretch images
        ...
        with col_box:
            ...
            try:
                ...
                if name == 'Residual':
                    ...
                    ax.imshow(arr, origin='lower', cmap='seismic')
                    ax.axis('off')
                    buf = BytesIO()
                ...
                if show_crop:
                    ...
                    if name == 'Residual':
                        ...
                        ax2.imshow(crop, origin='lower', cmap='seismic')
                        ax2.axis('off')
                        buf2 = BytesIO()
